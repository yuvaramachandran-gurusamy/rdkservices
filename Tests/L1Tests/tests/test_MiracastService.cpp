...
class MiracastServiceTest : public ::testing::Test {
			  ...
			  , connection(1, 0)
	{
		...
		ON_CALL(*p_wpaCtrlImplMock, wpa_ctrl_recv(::testing::_, ::testing::_, ::testing::_))
